...
//   ])
    ...
    const [videoWatching, setVideoWatching] = useState(videoItems[0])
                        ...
                        <div>
                            ...
                            <div className={styles.videoInfo1Container}>
                                <div className={styles.titleViewsContainer}>
                                    ...
                                    <span className={styles.viewCount}>{videoWatching.channel.subscribe} subscribers  •  Premiered on 13th Feb 2022
                                    {/* {videoWatching.uploadDate} */}
                                    </span>
                                </div>
                                ...
                                <div className={styles.videoItem} onClick={()=>playVideo(videoItem)}>
                                    ...
                                    <div className={styles.videoItemContentWrapper}>
                                        ...
                                        <div className={styles.videoDescContainer}>
                                            ...
                                            <br/>
                                            <span>{videoItem.channel.subscribe}M subscribers • 
                                            23 Days ago
                                            {/* {videoItem.uploadedOn} */}
                                             </span>
                                        </div>
                                    </div>
                                </div>
